...
const Home = () => {
  return (
    <div className='flex items-center justify-center mt-[120px]'><div className='flex gap-[70px] items-center'>
      <Social/>

      <div className='flex flex-col gap-3'><div className='flex gap-2 items-center'>
        <h1 className='text-black text-[20px] md:text-[50px] font-[500]'>Rohit Sharma</h1>
        <svg
                  width="32"
                  height="32"
                  viewBox="0 0 48 48"
      ...
      <div className='flex items-center gap-3'>
        ...
        <h1 className=' text-[20px]'>Frontend Developer</h1>
      </div>

      <h1 className='md:w-[656px]'>
      I am a passionate frontend web developer seeking a challenging role to apply technical skills and creativity to solve problems. Proficient in HTML5, CSS, JavaScript, React.js, React Native, Redux toolkit and DSA. Istrive to create visually appealing and interactive user interfaces. I excel in writing clean and optimized code.I am confident in my ability to contribute to any project or team I am part of.
      </h1>

      <div className='bg-gray-700 w-[150px] rounded-[12px] p-[6px] cursor-pointer'>
        <div className='flex items-center justify-center'><h1 className='text-white'>Say Hello</h1></div>
      </div>
